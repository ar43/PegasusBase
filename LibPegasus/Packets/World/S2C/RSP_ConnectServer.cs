...
namespace LibPegasus.Packets.World.S2C
{
	public class RSP_ConnectServer<ClientClass> : Packet<ClientClass>
	{
		...
		public RSP_ConnectServer(Byte connectionResult, UInt32 authKey, UInt16 userIdx, byte[] serverNonce, byte[] publicServerKey) : base((UInt16)OpcodeWorld.CONNECTSERVER)
		{
